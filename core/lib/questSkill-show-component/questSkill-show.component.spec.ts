...
import { QuestSkillShowComponent } from './questSkill-show.component';
...
describe('QuestSkillShowComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', async(() => {
    const fixture = TestBed.createComponent(QuestSkillShowComponent);
