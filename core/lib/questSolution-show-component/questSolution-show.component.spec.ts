...
import { QuestSolutionShowComponent } from './questSolution-show.component';
...
describe('QuestSolutionShowComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', async(() => {
    const fixture = TestBed.createComponent(QuestSolutionShowComponent);
